...
def my_train_test_split(data, time, label, mask1, mask2, test_size):
    tr_data=data[:-test_size,:]
    te_data=data[-test_size:,:]
    tr_time=time[:-test_size,:]
    te_time=time[-test_size:,:]
    tr_label=label[:-test_size,:]
    te_label=label[-test_size:,:]
    tr_mask1=mask1[:-test_size,:,:]
    te_mask1=mask1[-test_size:,:,:]
    tr_mask2=mask2[:-test_size,:]
    te_mask2=mask2[-test_size:,:]
    
    return tr_data,te_data, tr_time,te_time, tr_label,te_label,\
         tr_mask1,te_mask1, tr_mask2,te_mask2
